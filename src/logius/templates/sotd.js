...
` : ""}
${conf.specType=="ST" && conf.isGNDEF ? html ` De programmaraad van Logius heeft deze standaard goedgekeurd.` : ""}
${conf.specType=="ST" && conf.isGNVV ? html ` De programmaraad van Logius beoordeelt dit definitief concept. Keurt zij het goed, dan is er een nieuwe standaard.` : ""}
